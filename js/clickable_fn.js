...
var p1name = $('#p1name').html();
var p2name = $('#p2name').html();
...
function createBoard(){
 ...
 $(".alert").html('<h4 style="text-align: center;"><strong>Move ! Move ! </strong> <em>'+p1name+' </em> its time to move your Zombie.</h4>');
  }
  else if(play==3 ){
   colorify(clickable(p2pos));
 $(".alert").html('<h4 style="text-align: center;"><strong>Move ! Move ! </strong> <em>'+p2name+' </em> its time to move your Zombie.</h4>');
  }


   if(play==2){

    $(".alert").html('<h4 style="text-align: center;"><strong>Eat ! Eat ! </strong> <em>'+p1name+' </em> its time to Eat up.</h4>');

  }

  else if(play==4){

    $(".alert").html('<h4 style="text-align: center;"><strong>Eat ! Eat ! </strong> <em>'+p2name+'</em> its time to Eat up.</h4>');
  }
...
$(".box").click(function(){
  ...
  if (play==4) {
    ...
    if (id1!=pl1 && id1!=pl2) {
      ...
      colorify(clickable(parseInt(pl1)));
       if (q.length==0) {
      //alert("Player1 Lost.");
      $('.alert').html('<h4 style="text-align: center;"><strong>Wohoo ! Hurray ! </strong> <em> '+p2name+' </em> Wins.</h4>');
    }else{
        if (q2.length==0) {
          $('.alert').html('<h4 style="text-align: center;"><strong>Wohoo ! Hurray ! </strong> <em>'+p1name+' </em> Wins.</h4>');
        }
        else {
  ...
  if (play==3) {
    ...
    if (q.length == 0) {
      //alert("Player2 Lost.");
      $('.alert').html('<h4 style="text-align: center;"><stylerong>Wohoo ! Hurray ! </strong> <em>'+p1name+' </em> Wins.</h4>');
    }
