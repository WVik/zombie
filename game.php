...
?>
  ...
  $gamedetails=mysql_query("SELECT pl1pos,pl2pos,redbox,rno,turn from gameboard WHERE string='$string'") or die("pl1pos");
  ...
  <p id="p1name" hidden><?php echo $_SESSION['p1name']; ?></p>
  <p id="p2name" hidden><?php echo $_SESSION['p2name']; ?></p>
  </div>
